...
class CounterView: UIView {
    ...
    func updateLabel() {
        ...
        countLabel.attributedText = NSAttributedString(string: countString, attributes: [NSAttributedStringKey.font: UIFont.init(name: "OpenSans-Bold", size: 17)!, NSAttributedStringKey.foregroundColor: UIColor.white])
    }
